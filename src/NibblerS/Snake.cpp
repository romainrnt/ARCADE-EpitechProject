...
Arcade::GameSnake::GameSnake()
{
    ...
    _titleText = new Text(50, 10, "Nibbler", Arcade::YELLOW);
    ...
    _bgb.push_back(new Pixel(30, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(32, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(34, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(36, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(38, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(40, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(42, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(44, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(46, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(48, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(50, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(52, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(54, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(56, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(58, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(60, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(62, 40, Arcade::RED, 2));
    _bgb.push_back(new Pixel(30, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(32, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(34, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(36, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(38, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(40, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(42, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(44, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(46, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(48, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(50, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(52, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(54, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(56, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(58, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(60, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(62, 62, Arcade::RED, 2));
    _bgb.push_back(new Pixel(30, 42, Arcade::RED, 2));
    _bgb.push_back(new Pixel(30, 44, Arcade::RED, 2));
    _bgb.push_back(new Pixel(30, 46, Arcade::RED, 2));
    _bgb.push_back(new Pixel(30, 48, Arcade::RED, 2));
    _bgb.push_back(new Pixel(30, 50, Arcade::RED, 2));
    _bgb.push_back(new Pixel(30, 52, Arcade::RED, 2));
    _bgb.push_back(new Pixel(62, 42, Arcade::RED, 2));
    _bgb.push_back(new Pixel(62, 44, Arcade::RED, 2));
    _bgb.push_back(new Pixel(62, 46, Arcade::RED, 2));
    _bgb.push_back(new Pixel(62, 48, Arcade::RED, 2));
    _bgb.push_back(new Pixel(62, 50, Arcade::RED, 2));
    _bgb.push_back(new Pixel(62, 52, Arcade::RED, 2));
    _toAdd = false;
}
...
void Arcade::GameSnake::drawGraphics(IDisplayModule *libraryPtr)
{
    ...
    for (auto it = _bgb.begin(); it != _bgb.end(); it++)
...
void Arcade::GameSnake::checkWall() {
    int headX = _snake.front()->getXCoordinate();
    int headY = _snake.front()->getYCoordinate();
    for (std::size_t i = 0; i < _bgb.size(); ++i) {
        if (headX >= _bgb[i]->getXCoordinate() - 1 && headX <= _bgb[i]->getXCoordinate() + 1 &&
            headY >= _bgb[i]->getYCoordinate() - 1 && headY <= _bgb[i]->getYCoordinate() + 1) {
            if (_currentDirection == Direction::DIR_RIGHT)
                _nextDirection = Direction::DIR_LEFT;
            if (_currentDirection == Direction::DIR_RIGHT)
                _nextDirection = Direction::DIR_LEFT;
